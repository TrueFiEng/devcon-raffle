...
describe('useBidEvents', () => {
  ...
  it('Fetches logs', async () => {
    const mockLog = createMockBidLog(1, '0x2546bcd3c84621e976d8185a91a922ae77ecec30', '1.5')
    mockLogs = [mockLog]
    const { result } = render()
  ...
  it.skip('Appends new entries', async () => {
    const initialLog = createMockBidLog(1, '0x2546bcd3c84621e976d8185a91a922ae77ecec30', '1.5')
    mockLogs = [initialLog]
    ...
    jest.runAllTimers()
    const appendedLog = createMockBidLog(15, '0xbda5747bfd65f08deb54cb465eb87d40e51b197e', '2.5')
